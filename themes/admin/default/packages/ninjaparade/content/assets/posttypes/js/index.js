...
;(function(window, document, $, undefined)
{
	...
	Extension.Index.datePicker = function()
	{
		...
		$('.daterangepicker_start_input').attr('data-grid', 'posttype');

		$('.daterangepicker_end_input').attr('data-grid', 'posttype');
	...
	Extension.Index.dataGrid = function()
	{
		...
		Extension.Index.Grid = $.datagrid('posttype', '#data-grid', '#data-grid_pagination', '#data-grid_applied', config);
	};
