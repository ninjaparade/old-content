...
;(function(window, document, $, undefined)
{
	...
	Extension.Index.datePicker = function()
	{
		...
		$('.daterangepicker_start_input').attr('data-grid', 'author');

		$('.daterangepicker_end_input').attr('data-grid', 'author');
	...
	Extension.Index.dataGrid = function()
	{
		...
		Extension.Index.Grid = $.datagrid('author', '#data-grid', '#data-grid_pagination', '#data-grid_applied', config);
	};
