...
;(function(window, document, $, undefined)
{
	...
	Extension.Index.datePicker = function()
	{
		...
		$('.daterangepicker_start_input').attr('data-grid', 'post');

		$('.daterangepicker_end_input').attr('data-grid', 'post');
	...
	Extension.Index.dataGrid = function()
	{
		...
		Extension.Index.Grid = $.datagrid('post', '#data-grid', '#data-grid_pagination', '#data-grid_applied', config);
	};
