...
;(function(window, document, $, undefined)
{
	...
	Extension.Index.datePicker = function()
	{
		...
		$('.daterangepicker_start_input').attr('data-grid', 'categorie');

		$('.daterangepicker_end_input').attr('data-grid', 'categorie');
	...
	Extension.Index.dataGrid = function()
	{
		...
		Extension.Index.Grid = $.datagrid('categorie', '#data-grid', '#data-grid_pagination', '#data-grid_applied', config);
	};
