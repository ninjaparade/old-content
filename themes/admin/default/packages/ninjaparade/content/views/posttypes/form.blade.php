				...
				<div class="container-fluid">
					...
					<div class="navbar-header">
						...
						<ul class="nav navbar-nav navbar-cancel">
							<li>
								<a class="tip" href="{{ route('admin.ninjaparade.content.posttypes.all') }}" data-toggle="tooltip" data-original-title="{{{ trans('action.cancel') }}}">
									<i class="fa fa-reply"></i>  <span class="visible-xs-inline">{{{ trans('action.cancel') }}}</span>
								</a>
							</li>
						</ul>

						<span class="navbar-brand">{{{ trans("action.{$mode}") }}} <small>{{{ $posttype->exists ? $posttype->id : null }}}</small></span>
					</div>
					...
					<div class="collapse navbar-collapse" id="actions">
						...
						<ul class="nav navbar-nav navbar-right">
							...
							@if ($posttype->exists)
							<li>
								<a href="{{ route('admin.ninjaparade.content.posttypes.delete', $posttype->id) }}" class="tip" data-action-delete data-toggle="tooltip" data-original-title="{{{ trans('action.delete') }}}" type="delete">
		...
		<div class="panel-body">
			...
			<div role="tabpanel">
				...
				<div class="form-group{{ $errors->first('name', ' has-error') }}">
									...
									<label for="name" class="control-label">{{{ trans('ninjaparade/content::posttypes/form.name') }}} <i class="fa fa-info-circle" data-toggle="popover" data-content="{{{ trans('ninjaparade/content::posttypes/form.name_help') }}}"></i></label>

									<input type="text" class="form-control" name="name" id="name" placeholder="{{{ trans('ninjaparade/content::posttypes/form.name') }}}" value="{{{ Input::old('name', $posttype->name) }}}">
